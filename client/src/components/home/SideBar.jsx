    ...
    <div>
      ...
      <div className="flex flex-col max-w-[200px]">
        <div className="border-b border-gray-300 pb-2">
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ...
                : "flex gap-3 items-center bg-white px-3 py-2 rounded-lg mt-2"
            }
          >
            <IoMdHome size={25} />
          ...
          >
            <MdSubscriptions size={25} />
            <p className="text-[14px] font-medium text-black">Subscriptions</p>
          </NavLink>
        </div>
        <div className="border-b border-gray-300 pb-2">
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ...
                : "flex gap-3 items-center bg-white px-3 py-2 rounded-lg mt-1"
            }
          >
            <FaHistory size={25} />
